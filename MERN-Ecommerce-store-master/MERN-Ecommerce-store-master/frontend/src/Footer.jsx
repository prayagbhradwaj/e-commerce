  ...
  return (
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        <img
          src="C:\Users\Prayag\Downloads\MERN-Ecommerce-store-master\MERN-Ecommerce-store-master\frontend\src\logo.png"
